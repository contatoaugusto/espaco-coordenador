    ...
    public class DLancamento
    {
        ...
        public List<TIPO_LANCAMENTO> ConsultarTipolancamento()
        {
            using (ALICE2Entities db = new ALICE2Entities())
            {
                ...
                List<EC.Modelo.TIPO_LANCAMENTO> ltTipolancamento = new List<EC.Modelo.TIPO_LANCAMENTO>();
         ...
         public List<PESSOA> ConsultarPessoa()
        {
         ...
         public List<TURMA> ConsultarTurma()
         {
             using (ALICE2Entities db = new ALICE2Entities())
             {
                 ...
                 List<EC.Modelo.TURMA> ltTurma = new List<EC.Modelo.TURMA>();
        ...
        public List<LANCAMENTO> ConsultarLancamento()
        {
            using (ALICE2Entities db = new ALICE2Entities())
            {
                ...
                List<EC.Modelo.LANCAMENTO> ltLancamento = new List<EC.Modelo.LANCAMENTO>();
