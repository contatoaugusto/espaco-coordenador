...
(function($) {
    $.fn.textCounting = function(parameters) {
        var opts = $.extend({}, $.fn.textCounting.defaults, parameters); if (opts.maxLengthSource == "list") {
        ...
        return this.each(function() {
            var $box = $(this); var options = $.metadata ? $.extend({}, opts, $box.metadata()) : opts; var proceed = true; if (options.excludeIds != "")
    ...
    }; $.fn.textCounting.defaults = { maxLengthSource: "attribute", maxLengthList: "", maxLengthAttribute: "maxLength", countWhat: "characters", countDirection: "down", targetModifierType: "suffix", targetModifier: "Down", lengthExceededClass: "", excludeIds: "" }; $.fn.textCounting.calculateCount = function(obj, countWhat, direction, maxCount) {
        ...
        switch (modifierType) { case "id": var $targetElement = $("#" + target); break; case "prefix": var $targetElement = $("#" + target + obj.attr("id")); break; case "suffix": var $targetElement = $("#" + obj.attr("id") + target); break; }
        ...
        var outcome = true; var exclusionArray = excluded.split(","); for (var c = 0; c < exclusionArray.length; c++) {
