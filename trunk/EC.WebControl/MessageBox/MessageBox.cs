...
#region Styles
[assembly: WebResourceAttribute("SGI.UI.WebControls.MessageBox.Styles.Outlook.css", "text/css")]
[assembly: WebResourceAttribute("SGI.UI.WebControls.MessageBox.Styles.UniCEUB.css", "text/css")]
#endregion Styles

#region Images
[assembly: WebResource("SGI.UI.WebControls.MessageBox.MessageBox-Close.gif", "image/gif")]
[assembly: WebResource("SGI.UI.WebControls.MessageBox.MessageBox-Information.gif", "image/gif")]
[assembly: WebResource("SGI.UI.WebControls.MessageBox.MessageBox-Question.gif", "image/gif")]
[assembly: WebResource("SGI.UI.WebControls.MessageBox.MessageBox-Warning.gif", "image/gif")]
[assembly: WebResource("SGI.UI.WebControls.MessageBox.MessageBox-Error.gif", "image/gif")]
#endregion Images

#region JavaScript
//[assembly: WebResourceAttribute("SGI.UI.WebControls.jQuery.jQuery.js", "text/javascript")]
[assembly: WebResourceAttribute("SGI.UI.WebControls.jQuery.jquery.blockUI.js", "text/javascript")]
...
namespace EC.UI.WebControls
{
    ...
    public class MessageBox : Control, IPostBackEventHandler
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            string closeImage = Page.ClientScript.GetWebResourceUrl(GetType(), "SGI.UI.WebControls.MessageBox.MessageBox-Close.gif");
            ...
            string iconImage = Page.ClientScript.GetWebResourceUrl(GetType(), "SGI.UI.WebControls.MessageBox.MessageBox-" + Type.ToString() + ".gif");
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            RegisterCss(string.Format("SGI.UI.WebControls.MessageBox.Styles.{0}.css", Skin.ToString()));

            //if (!Page.ClientScript.IsClientScriptIncludeRegistered("JQUERY"))
            //    Page.ClientScript.RegisterClientScriptInclude("JQUERY", Page.ClientScript.GetWebResourceUrl(GetType(), "SGI.UI.WebControls.jQuery.jquery-1.2.6.js"));

            if (!Page.ClientScript.IsClientScriptIncludeRegistered("BLOCKUI"))
                Page.ClientScript.RegisterClientScriptInclude("BLOCKUI", Page.ClientScript.GetWebResourceUrl(GetType(), "SGI.UI.WebControls.jQuery.jquery.blockUI.js"));
        }
