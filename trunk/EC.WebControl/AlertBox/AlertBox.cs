...
[assembly: WebResourceAttribute("SGI.UI.WebControls.AlertBox.AlertBox.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResourceAttribute("SGI.UI.WebControls.AlertBox.AlertBox.css", "text/css", PerformSubstitution = true)]
...
namespace EC.UI.WebControls
{
    ...
    public class AlertBox : Control
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            RegisterCss("SGI.UI.WebControls.AlertBox.AlertBox.css");

            if (!Page.ClientScript.IsClientScriptIncludeRegistered("WCAB"))
                Page.ClientScript.RegisterClientScriptInclude("WCAB", Page.ClientScript.GetWebResourceUrl(GetType(), "SGI.UI.WebControls.AlertBox.AlertBox.js"));
