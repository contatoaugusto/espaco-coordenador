...
#region Styles
[assembly: WebResourceAttribute("EC.UI.WebControls.TextArea.TextArea.css", "text/css", PerformSubstitution = true)]
#endregion Styles

#region Images
[assembly: WebResource("EC.UI.WebControls.TextArea.grippie.png", "image/png")]
#endregion Images

#region JavaScript
//[assembly: WebResourceAttribute("EC.UI.WebControls.jQuery.jQuery.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResourceAttribute("EC.UI.WebControls.jQuery.jquery.textarearesizer.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResourceAttribute("EC.UI.WebControls.jQuery.jquery.textcounting.js", "text/javascript", PerformSubstitution = true)]
...
namespace EC.UI.WebControls
{
    ...
    public class TextArea : System.Web.UI.WebControls.TextBox
    {
        ...
        {
            base.OnInit(e);
            RegisterCss("EC.UI.WebControls.TextArea.TextArea.css");

            string image = Page.ClientScript.GetWebResourceUrl(GetType(), "EC.UI.WebControls.TextArea.grippie.png");
            ...
            RegisterClientScriptInclude("WCTATAA", "EC.UI.WebControls.jQuery.jquery.textarearesizer.js");
            RegisterClientScriptInclude("WCTATC", "EC.UI.WebControls.jQuery.jquery.textcounting.js");
