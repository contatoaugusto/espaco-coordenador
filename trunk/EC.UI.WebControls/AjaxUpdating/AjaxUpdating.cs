...
[assembly: WebResourceAttribute("EC.UI.WebControls.AjaxUpdating.AjaxUpdating.css", "text/css", PerformSubstitution = true)]
[assembly: WebResourceAttribute("EC.UI.WebControls.AjaxUpdating.AjaxUpdating.js", "text/javascript", PerformSubstitution = true)]
[assembly: WebResource("EC.UI.WebControls.AjaxUpdating.Default.gif", "image/gif")]
...
namespace EC.UI.WebControls
{
    ...
    public class AjaxUpdating : Control
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            RegisterCss("EC.UI.WebControls.AjaxUpdating.AjaxUpdating.css");

            if (!Page.ClientScript.IsClientScriptIncludeRegistered("WCAU"))
                Page.ClientScript.RegisterClientScriptInclude("WCAU", Page.ClientScript.GetWebResourceUrl(GetType(), "EC.UI.WebControls.AjaxUpdating.AjaxUpdating.js"));

        }

        protected override void Render(HtmlTextWriter writer)
        {
            string urlImage = Page.ClientScript.GetWebResourceUrl(GetType(), "EC.UI.WebControls.AjaxUpdating.Default.gif");
