...
namespace EC.Paginas
{
    public partial class ConsultarAcao : System.Web.UI.Page
    {
        ...
        {
            ddlStatus.DataSource = EC.Negocio.NAcao.ConsultarStatus();
        ...
        {
            ddlPrioridade.DataSource = EC.Negocio.NAcao.ConsultarPrioridade();
        ...
        {
           ACAO acao = new ACAO();
            grdAcao.DataSource = EC.Negocio.NAcao.ConsultarAcao(acao);
            grdAcao.DataBind();
        }
