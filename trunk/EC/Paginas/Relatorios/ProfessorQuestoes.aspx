...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Chart ID="chartProfessorQuestao" runat="server" Width="924px" Height="356px" style="margin-top: 31px" OnPrePaint="chartProfessorQuestao_Load" OnDataBound="chartProfessorQuestao_DataBound">
        <%--<Titles>
    ...
    <asp:Chart ID="chartProfessorQuestao2" runat="server" Width="924px" Height="351px" style="margin-top: 25px" >
        <%--<Titles>
