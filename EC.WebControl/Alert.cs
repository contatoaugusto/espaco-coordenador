...
[assembly: WebResourceAttribute("SGI.UI.WebControls.Alert.css", "text/css", PerformSubstitution = true)]
...
namespace EC.UI.WebControls
{
    ...
    public class Alert : Control, IPostBackDataHandler, IPostBackEventHandler
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            //    Page.ClientScript.RegisterClientScriptInclude("WebControlsAlert", Page.ClientScript.GetWebResourceUrl(GetType(), "SGI.UI.WebControls.Alert.js"));

            if (StyleAlert == StyleAlert.SGI2005)
            {
                string alias = "SGI.UI.WebControls.Alert.css";
